...
class Cubie:
    ...
    def rotate(self, matrix):
        ...
        # Be ware of this part. In any case, we only need to swap 2 colors.
...
class Cube:
    ...
    def _face(self, axis):
        """
        axis: One of LEFT, RIGHT, UP, DOWN, FRONT, BACK
        and returns a list of Pieces on the given face
        """
    ...
    def _slice(self, plane):
        """
        plane: a sum of any two of X_AXIS, Y_AXIS, Z_AXIS (e.g. X_AXIS + Y_AXIS)
        and returns a list of Pieces in the given plane
        """
    ...
    def L(self):
        return self._rotate_face(LEFT, ROT_YZ_CC)

    def Li(self):
        return self._rotate_face(LEFT, ROT_YZ_CW)

    def R(self):
        return self._rotate_face(RIGHT, ROT_YZ_CW)

    def Ri(self):
        return self._rotate_face(RIGHT, ROT_YZ_CC)

    def U(self):
        return self._rotate_face(UP, ROT_XZ_CW)

    def Ui(self):
        return self._rotate_face(UP, ROT_XZ_CC)

    def D(self):
        return self._rotate_face(DOWN, ROT_XZ_CC)

    def Di(self):
        return self._rotate_face(DOWN, ROT_XZ_CW)

    def F(self):
        return self._rotate_face(FRONT, ROT_XY_CW)

    def Fi(self):
        return self._rotate_face(FRONT, ROT_XY_CC)

    def B(self):
        return self._rotate_face(BACK, ROT_XY_CC)
    ...
    def sequence(self, move_str):
        """
        moves: A string containing notated moves separated by spaces, for example: "L Ri U M Ui B M"
        """
